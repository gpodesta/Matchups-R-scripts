...
tt10 <- round(tapply(orig3$SST.latband1.res, INDEX=orig3$qsst.new, FUN=IQR, na.rm=TRUE, simplify=TRUE),3)
tt11 <- round(tapply(orig3$SST.latband1.res, INDEX=orig3$qsst.new, FUN=length, simplify=TRUE),3)

tt12 <- data.frame(quality=names(table(orig3$qsst.new)), min=tt1, q1=tt2, median=tt3, mean=tt4,
...
rm(tt1,tt2,tt3,tt4,tt5,tt6,tt7,tt8,tt9,tt10,tt11,orig3);gc()
# ----------------------------------------------------------------------------------------
